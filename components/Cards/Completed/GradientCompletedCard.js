...
const GradientCompletedCard = memo(({ workout, style }) => {
  return (
      ...
      <View style={styles.gradient}>
        ...
        <View style={styles.statsRow}>
          <View style={styles.stat}>
            <Feather name="check" size={16} color="rgba(255,255,255,0.8)" />
...
GradientCompletedCard.displayName = "GradientCompletedCard";
...
export default GradientCompletedCard;
