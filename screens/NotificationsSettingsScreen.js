    ...
    >
      ...
      >
        <Section title="Workout Reminders">
          <SettingRow icon="bell" label="Workout Reminders" type="toggle" value={true} />
          <SettingRow icon="clock" label="Reminder Time" onPress={() => {}} />
          <SettingRow icon="calendar" label="Days of Week" onPress={() => {}} />
        </Section>

        <Section title="Streak & Progress">
          <SettingRow icon="flame" label="Streak Reminders" type="toggle" value={true} />
          <SettingRow icon="trending-up" label="Weekly Summary" type="toggle" value={false} />
        </Section>

        <Section title="Preferences">
          <SettingRow icon="volume-2" label="Sound" type="toggle" value={true} />
          <SettingRow icon="vibrate" label="Vibration" type="toggle" value={true} />
        </Section>
      </ScrollView>
    </DynamicSafeAreaView>
  );
